...
public class LineLinearLayout extends LinearLayout {
    ...
    public LineLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray attr = context.obtainStyledAttributes(attrs, R.styleable.LineLinearLayout);
        lineMarginSide = attr.getDimensionPixelOffset(R.styleable.LineLinearLayout_line_margin_side, 10);
        lineDynamicDimen = attr.getDimensionPixelOffset(R.styleable.LineLinearLayout_line_dynamic_dimen, 0);
        lineStrokeWidth = attr.getDimensionPixelOffset(R.styleable.LineLinearLayout_line_stroke_width, 2);
        lineColor = attr.getColor(R.styleable.LineLinearLayout_line_color, 0xff3dd1a5);
        pointSize = attr.getDimensionPixelSize(R.styleable.LineLinearLayout_point_size, 8);
        pointColor = attr.getDimensionPixelOffset(R.styleable.LineLinearLayout_point_color, 0xff3dd1a5);

        int iconRes = attr.getResourceId(R.styleable.LineLinearLayout_icon_src, R.drawable.ic_ok);
