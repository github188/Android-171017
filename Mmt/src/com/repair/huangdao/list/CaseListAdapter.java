...
import com.repair.huangdao.detail.CaseDetailFragmentFull;

import java.util.List;

public class CaseListAdapter extends BaseAdapter {
    protected final MyCaseHDActivity activity;
    protected final List<CaseItem> caseItems;
    protected final LayoutInflater inflater;

    public CaseListAdapter(BaseActivity activity, List<CaseItem> caseItems) {
        this.activity = (MyCaseHDActivity) activity;
...
//                R.anim.slide_out_left);
        ...
        Fragment fragment = manager.findFragmentByTag(CaseDetailFragmentFull.class.getName());

        if (fragment == null) {
            fragment = new CaseDetailFragmentFull();
            ...
            transaction.add(R.id.base_root_relative_layout, fragment, CaseDetailFragmentFull.class.getName());
        }
