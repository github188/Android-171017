...
public class CaseListFragment extends BackHandledFragment implements View.OnTouchListener, View.OnClickListener, OnItemClickListener {
    ...
    public void onHiddenChanged(boolean hidden) {
        try {
            ...
            if (!hidden) {//列表重新被显示的时候，手动设置焦点，因为返回的时候，焦点会被重置为第一个
                ...
                MyCaseHDActivity activity = (MyCaseHDActivity) getActivity();

                if (!TextUtils.isEmpty(activity.shouldRefresh))
                    refreshAll();
    ...
    public void initSearchCondition(View view) {
        ...
        //暂时屏蔽黄岛在办的条件筛选功能
        view.findViewById(R.id.btnFilter).setVisibility(View.GONE);
    ...
    static abstract class LevelTwoAdapt extends BaseAdapter implements OnItemClickListener {
        Context context;
        LevelItem item;
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            tv.setTextSize(DimenTool.dip2px(context, 10));
