...
import com.mapgis.mmt.module.webappentry.BridgeHandler;
import com.mapgis.mmt.module.webappentry.BridgeWebView;
import com.mapgis.mmt.module.webappentry.CallBackFunction;
import com.mapgis.mmt.module.webappentry.DefaultHandler;
import com.mapgis.mmt.module.webappentry.HotWebChomeClient;
import com.mapgis.mmt.module.webappentry.ImageUtil;
import com.mapgis.mmt.module.webappentry.WebAppActivity;
...
/**
 * Created by cmios on 2017/9/21.
 */

public class ScadaWebView extends BaseActivity implements HotWebChomeClient.OpenFileChooserCallBack {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.loadUrl("http://192.168.12.129:8000/#/StationDetail?from=android&station="+station);

        ScadaWebView.User user = new ScadaWebView.User();
            ...
            public void handler(String data, CallBackFunction function) {
                ...
                try {
                    ...
                    if (jsonObject.has("XY")) {
                        ...
                        BaseMapCallback callback = new ShowMapPointCallback(ScadaWebView.this, xy, title, "", -1);
        ...
        webView.callHandler(getResources().getString(R.string.js_get_usr_info), new Gson().toJson(user), new CallBackFunction() {
            ...
            public void onCallBack(String data) {
                Toast.makeText(ScadaWebView.this, "已获取用户信息", Toast.LENGTH_LONG).show();
            }
        });
    ...
    public void showOptions() {
        ...
        alertDialog.setOnCancelListener(new ScadaWebView.ReOnCancelListener());
