 ...
 */
public class JDConstructNavigationnMenu extends BaseNavigationMenu {

    public JDConstructNavigationnMenu(NavigationActivity navigationActivity, NavigationItem item) {
