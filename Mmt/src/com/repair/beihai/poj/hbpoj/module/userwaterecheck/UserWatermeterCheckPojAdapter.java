 ...
 */
public class UserWatermeterCheckPojAdapter extends SimpleBaseAdapter implements View.OnClickListener {

    protected List<CheckWatermeterPoj> dataList;
    protected BaseActivity context;
    protected LayoutInflater inflater;

    public UserWatermeterCheckPojAdapter(BaseActivity activity, List<CheckWatermeterPoj> data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final CheckWatermeterPoj caseItem = dataList.get(position);
        ...
        ((TextView) MmtViewHolder.get(convertView, R.id.tv_mid_four_left)).setText("用户数:" + caseItem.hasLinkUserCount);
        ((TextView) MmtViewHolder.get(convertView, R.id.tv_mid_five_left)).setText("已审核:" + caseItem.hasCheckUserCount);
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.detail) {
            ...
            if (tag == null || TextUtils.isEmpty(tag.toString())) {
                ...
                Intent intent = new Intent(context, UserWatermeterCheckPojDetail.class);
    ...
    public void onItemClick(int position) {
        ...
        CheckWatermeterPoj watermeterPoj = dataList.get(position);

        Intent intent = new Intent(context, WatermeterUserCheckListActivity.class);
