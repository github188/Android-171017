 ...
 */
public class GCConstructNavigationnMenu extends BaseNavigationMenu {

    public GCConstructNavigationnMenu(NavigationActivity navigationActivity, NavigationItem item) {
