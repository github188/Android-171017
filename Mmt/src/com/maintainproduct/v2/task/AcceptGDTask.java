 ...
 * @author meikai
 */
public class AcceptGDTask extends AsyncTask<ReportItem, Integer, String> {

	private BaseActivity activity;
	private Handler handler;

	public AcceptGDTask(BaseActivity activity, Handler handler) {
		super();
	...
	protected String doInBackground(ReportItem... params) {
		...
		try {
			String url = ServerConnectConfig.getInstance().getBaseServerPath()
					+ "/Services/MapgisCity_WXYH_GL_MOBILE/REST/CaseManageREST.svc/Accept";
	...
	protected void onPostExecute(String result) {
		...
		msg.what = MaintainConstant.SERVER_RECEIVE_GD_DONE;
