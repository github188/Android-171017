package com.mapgis.mmt.module.gis.toolbar.trace;
 ...
 * 今日轨迹
 */
public class TodayTraceMenu extends BaseMapMenu implements MapViewExtentChangeListener, MapView.MapViewTapListener {
    View bottomBarView;

    public TodayTraceMenu(final MapGISFrame mapGISFrame) {
        super(mapGISFrame);
...
//                        offline.setLineWidth(6);
                        ...
                        GraphicPolylin offline = new GraphicPolylin(new Dot[]{startDot, endDot});
