...
import com.repair.auxiliary.conditionquery.changsha.SC_ConditionChoseActivity;

/**
 * Created by liuyunfan on 2016/4/14.
 */
public class CS_AuxConditionQueryMapMenu extends BaseMapMenu {
    public CS_AuxConditionQueryMapMenu(MapGISFrame mapGISFrame) {
        super(mapGISFrame);
    }
        ...
        try {
            AuxUtils.openAuxQuery(mapGISFrame, new AuxUtils.AfterOnsucess() {
                ...
                public void afterSucess() {
                    Intent intent = new Intent(mapGISFrame, SC_ConditionChoseActivity.class);
