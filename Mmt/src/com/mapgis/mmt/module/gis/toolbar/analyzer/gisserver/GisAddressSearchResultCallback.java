...
public class GisAddressSearchResultCallback extends BaseMapCallback {
	...
	public GisAddressSearchResultCallback(LocatorGeocodeResult.Candidate candidate) {
	...
	public GisAddressSearchResultCallback(Dot dot) {
		this.dot = dot;
		this.mode = SHOW_MINE;
	}
	...
	public GisAddressSearchResultCallback(LocatorGeocodeResult geocodeResult) {
