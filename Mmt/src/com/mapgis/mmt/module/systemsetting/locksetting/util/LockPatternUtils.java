...
import com.mapgis.mmt.module.systemsetting.locksetting.gesturepwd.LockPatternView;
...
public class LockPatternUtils {
	...
	/**
	 * The  nminimumumber of dots in a valid pattern.
	 */
	...
	public void saveLockPattern(List<LockPatternView.Cell> pattern) {
		...
		// save unlock style
//		CreateNumberPasswordActivity.saveUnlockStyle(CreateNumberPasswordActivity.UNLOCK_GESTURE_PWD);
	}
	 ...
	 * 
	 * @additionalParas pattern the gesture pattern.
	 * 
