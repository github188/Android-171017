...
public class CreateGesturePasswordActivity extends Activity implements
        OnClickListener, ICreatePasswordView {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (mPresenter == null) {
            this.mPresenter = new BaseCreatePasswordPresenter(this);
        }
//        // 初始化演示动画
...
//            saveChosenPatternAndFinish();
    ...
    public String getPwd() {
        return LockPatternUtils.patternToString(mChosenPattern);
    }

    @Override
    public int getPasswordType() {
        return PasswordType.PASSWORD_GESTURE;
    }
