...
public class DeviceListActivity extends Activity {
    ...
    private Set<String> mNewDevicesSet; // The address set of BluetoothDevice
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> pairedDevicesAdapter = new ArrayAdapter<>(this, R.layout.bluetooth_device_name);
