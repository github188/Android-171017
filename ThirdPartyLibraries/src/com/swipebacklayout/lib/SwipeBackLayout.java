...
public class SwipeBackLayout extends FrameLayout {
    ...
    private class ViewDragCallback extends ViewDragHelper.Callback {
        ...
        public boolean tryCaptureView(View view, int i) {
            ...
            // //////////////////////////////////////////////////////////////////////////
            /** Edit by WangLin 在任意点向右滑动都可以滑动结束界面 */
            // ret = true;
            // //////////////////////////////////////////////////////////////////////////
            if (ret) {
        ...
        public void onViewPositionChanged(View changedView, int left, int top, int dx, int dy) {
            try {
                ...
                if (mSwipeListener != null && mDragHelper.getViewDragState() == STATE_DRAGGING && mScrollPercent >= mScrollThreshold
                        && mIsScrollOverValid) {
                    mIsScrollOverValid = false;
                    mSwipeListener.onScrollOverThreshold();
                }

                if (mScrollPercent >= 1 && mSwipeListener != null) {
                    if (!mActivity.isFinishing()) {
                        // mActivity.finish();
                        mSwipeListener.onActivityFinish();
                    }
                }
            } catch (Exception ex) {
                ex.printStackTrace();
