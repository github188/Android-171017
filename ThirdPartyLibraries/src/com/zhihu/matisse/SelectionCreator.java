...
public final class SelectionCreator {
    ...
    public SelectionCreator defaultSelectedItems(List<Uri> defaultSelectedItems) {
        if (mSelectionSpec.defaultSelectedItems == null) {
            mSelectionSpec.defaultSelectedItems = new ArrayList<>();
        }
        if (defaultSelectedItems != null && defaultSelectedItems.size() > 0) {
            for (Uri uri : defaultSelectedItems) {
                mSelectionSpec.defaultSelectedItems.add(Item.valueOf(uri));
            }
        }
        return this;
    }
