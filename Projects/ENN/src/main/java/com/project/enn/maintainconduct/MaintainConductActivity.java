...
public class MaintainConductActivity extends CaseHandoverActivity {
    ...
    private void initData() {
        ...
        // 获取工单的流程对应的编号前缀
        final MmtBaseTask<String, Void, ResultData<String>> mmtBaseTask = new MmtBaseTask<String, Void, ResultData<String>>(MaintainConductActivity.this) {
            @Override
            ...
            protected void onSuccess(ResultData<String> resultData) {
                ...
                if (resultData == null) {
                    Toast.makeText(MaintainConductActivity.this, defErrMsg, Toast.LENGTH_SHORT).show();
                    return;
                }
                if (resultData.ResultCode != 200) {
                    Toast.makeText(MaintainConductActivity.this,
                ...
                if (resultData.DataList.size() == 0) {
                    Toast.makeText(MaintainConductActivity.this, "未查询到流程的编号前缀信息", Toast.LENGTH_SHORT).show();
                }
    ...
    protected void createBottomView() {
        BottomUnitView backUnitView = new BottomUnitView(MaintainConductActivity.this);
        ...
        addBottomUnitView(backUnitView, new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mScheduleTask != null) {
                    ...
                    listDialogFragment.setListItemClickListener(new ListDialogFragment.OnListItemClickListener() {
                        ...
                        public void onListItemClick(int arg2, String value) {
                            if (value.equals("物料清单")) {
                                Intent intent = new Intent(MaintainConductActivity.this, MaterialListActivity.class);
                                intent.putExtra("ListItemEntity", mScheduleTask);
                                startActivity(intent);

                            } else if (value.equals("采购订单")) {
                                Intent intent = new Intent(MaintainConductActivity.this, PurchaseOrderListActivity.class);
                                intent.putExtra("ListItemEntity", mScheduleTask);
                                startActivity(intent);
                            }
                        }
                    ...
                    Toast.makeText(MaintainConductActivity.this, "未获取到流程的编号前缀信息", Toast.LENGTH_SHORT).show();
                }
            }
        });

        super.createBottomView(true);
    }
}
